...
matrix matrix::operator*(const matrix& m)
{
	...
	temp._mat[X_][X_] = m._rows[X_] * m._cols[X_];
	temp._mat[X_][Y_] = m._rows[X_] * m._cols[Y_];
	temp._mat[X_][Z_] = m._rows[X_] * m._cols[Z_];
	temp._mat[X_][O_] = m._rows[X_] * m._cols[O_];
	temp._mat[Y_][X_] = m._rows[Y_] * m._cols[X_];
	temp._mat[Y_][Y_] = m._rows[Y_] * m._cols[Y_];
	temp._mat[Y_][Z_] = m._rows[Y_] * m._cols[Z_];
	temp._mat[Y_][O_] = m._rows[Y_] * m._cols[O_];
	temp._mat[Z_][X_] = m._rows[Z_] * m._cols[X_];
	temp._mat[Z_][Y_] = m._rows[Z_] * m._cols[Y_];
	temp._mat[Z_][Z_] = m._rows[Z_] * m._cols[Z_];
	temp._mat[Z_][O_] = m._rows[Z_] * m._cols[O_];
	temp._mat[O_][X_] = m._rows[O_] * m._cols[X_];
	temp._mat[O_][Y_] = m._rows[O_] * m._cols[Y_];
	temp._mat[O_][Z_] = m._rows[O_] * m._cols[Z_];
	temp._mat[O_][O_] = m._rows[O_] * m._cols[O_];
